...
TutorAid is a comprehensive solution with complete integration of its features. Some of its main features include: tasks, reminders, notes, student profile and earnings. Our features have been tailored to suit the needs of our target audience.
...
** What it does: allows users to add Reminders. These will then be displayed in a reminders window that will pop up to remind users of urgent tasks.
